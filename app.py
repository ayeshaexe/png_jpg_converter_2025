...
st.write("Easily converts your PNG file to JPG file, allowing to manipulate and modify the image.🌆")
...
if image_uploader  is not None:
    ...
    st.image(jpg, caption="Converted JPG (Resized)", use_container_width=True)
